...
class EncoderDecoder(nn.Module):
    ...
    def forward(self, sample):
        ...
        vector_2d = self.heatmaps_to_coordinates(heatmaps,sample.device) # sample['image']
        ...
        return {'heatmaps': heatmaps, 'vector_2d': vector_2d,'vector_3d': out_3d} #'vector_3d': out_3d, 